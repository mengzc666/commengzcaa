...
/**
 * @author Mengzc
 * @create 2021-03-28 11:50
 */
public class CDCWithCustomerSchema {
    public static void main(String[] args) throws Exception {

        //1.创建执行环境  todo 需要开启binlog /etc/my.cnf
        ...
        DebeziumSourceFunction<String> mysqlSource = MySQLSource.<String>builder()
                ...
                .username("root")
                .password("123456")
                .databaseList("gmall200720")
                .tableList("gmall200720.base_province")         //可选配置项,如果不指定该参数,则会读取上一个配置下的所有表的数据,注意：指定的时候需要使用"db.table"的方式
